...
import {URL_GLOBAL} from '../../content/pages/components/e-commerce/_core/global'
...
export class AuthenticationService implements AuthService {
	...
	//login***************************************************************
	public url:string=URL_GLOBAL;
	public identity;
	public token;
	cambiarClave(data) {
		let params=JSON.stringify(data);
		let headers=new Headers({'Content-Type':'application/json'});
		return this.http.post<any>(this.url+'cambiarclave',params);						 
	}
