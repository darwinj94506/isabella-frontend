...
export class FakeApiService implements InMemoryDbService {
	...
	createDb(): {} | Observable<{}> {
		return {
			...
			// importaciones
			importaciones:ECommerceDataContext.importaciones,
			//productos
			productos:ECommerceDataContext.productos,
			importacionProductos:ECommerceDataContext.importacionProductos
		};
	}
}
