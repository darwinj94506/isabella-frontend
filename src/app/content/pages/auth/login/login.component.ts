import {
	Component,OnInit,Output,Input,ViewChild,OnDestroy,ChangeDetectionStrategy,ChangeDetectorRef,HostBinding
} from '@angular/core';
...
export class LoginComponent implements OnInit, OnDestroy {
	public model: any = { cedula: '', password: '' };
	...
	validate(f: NgForm) {
		...
		// }
		if (objectPath.get(f, 'form.controls.cedula.errors.required')) {
